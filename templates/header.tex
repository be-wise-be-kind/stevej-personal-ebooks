...
\titlespacing*{\subsection}{0pt}{6ex plus 1ex minus .2ex}{2.5ex plus .2ex}
\titlespacing*{\subsubsection}{0pt}{3ex plus 1ex minus .2ex}{2ex plus .2ex}

% Widen TOC number columns to prevent "15.22Title" cramming
\usepackage{tocloft}
\setlength{\cftsecnumwidth}{3.5em}
\setlength{\cftsubsecnumwidth}{4.5em}

% Limit section numbering to 3 levels: chapter.section.subsection
% subsubsection (####) and deeper will be unnumbered
\setcounter{secnumdepth}{2}

% Style unnumbered subsubsection headings (####)
% Large bold - stands out clearly as a heading without number
...
% Style code blocks with background color and vertical spacing
\usepackage{framed}
\usepackage{mdframed}
